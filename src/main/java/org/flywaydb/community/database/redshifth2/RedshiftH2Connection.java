...
public class RedshiftH2Connection extends Connection<RedshiftH2Database> {
    RedshiftH2Connection(RedshiftH2Database database, java.sql.Connection connection) {
    ...
    public Schema getSchema(String name) {
        return new RedshiftH2Schema(jdbcTemplate, database, name);
    }
}
