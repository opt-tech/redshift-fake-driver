...
public class RedshiftPostgreSQLSchema extends Schema<RedshiftPostgreSQLDatabase, RedshiftPostgreSQLTable> {
    RedshiftPostgreSQLSchema(JdbcTemplate jdbcTemplate, RedshiftPostgreSQLDatabase database, String name) {
    ...
    @Override
    protected RedshiftPostgreSQLTable[] doAllTables() throws SQLException {
        ...
        RedshiftPostgreSQLTable[] tables = new RedshiftPostgreSQLTable[tableNames.size()];
        for (int i = 0; i < tableNames.size(); i++) {
            tables[i] = new RedshiftPostgreSQLTable(jdbcTemplate, database, this, tableNames.get(i));
        }
        return tables;
    }
    ...
    public Table getTable(String tableName) {
        return new RedshiftPostgreSQLTable(jdbcTemplate, database, this, tableName);
    }

    @Override
    protected Type getType(String typeName) {
        return new RedshiftPostgreSQLType(jdbcTemplate, database, this, typeName);
    }
}
