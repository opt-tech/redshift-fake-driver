...
public class RedshiftPostgreSQLConnection extends Connection<RedshiftPostgreSQLDatabase> {
    RedshiftPostgreSQLConnection(RedshiftPostgreSQLDatabase database, java.sql.Connection connection) {
    ...
    public Schema getSchema(String name) {
        return new RedshiftPostgreSQLSchema(jdbcTemplate, database, name);
    }
}
